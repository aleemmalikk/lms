    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          required
          rows={3}
          className="text-black w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#112772]"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="text-black w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#112772] disabled:bg-gray-100"
          >
