...
export default function BusinessLoanPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Instant Loan Application:", formData);
    setShowSuccess(true);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Fuel your business growth with our tailored loan solutions. 
            Get funding from ₹5 lakhs to ₹2 crores with minimal documentation.
          </p>
        </div>
