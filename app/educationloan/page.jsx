      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Achieve your higher education goals with flexible education loan solutions. Avail funding from ₹5 lakhs to ₹2 crores with minimal paperwork and quick disbursal.
          </p>
        </div>
